...
export default function Header() {
  ...
  const textColor = isSolid ? '#032D46' : 'white';
  const iconColor = isSolid ? '#032D46' : 'white';
                ...
                <div className="flex flex-col" style={{ marginLeft: '12px' }}>
                  ...
                  <span 
                    ...
                    style={{
                      ...
                      fontWeight: 500,
                      letterSpacing: '0.8px',
                      color: isSolid ? '#4A4A4A' : 'rgba(255,255,255,0.9)',
                      marginTop: '2px',
                      lineHeight: 1.1,
                      transition: 'color 0.3s ease'
                    }}
            ...
            >
              {navLinks.map((link) => (
                <Link
                  key={link.name}
                  href={link.href}
                  className="mega-menu-trigger transition-colors duration-200 whitespace-nowrap"
                  style={{
          ...
          {isSearchOpen && (
            <motion.div
              ...
              style={{ 
                ...
                background: isSolid ? '#ffffff' : 'rgba(0,0,0,0.8)',
            ...
            >
              <div className="max-w-[600px] mx-auto">
                <input
                  ...
                  className="w-full"
                  style={{ 
                    backgroundColor: isSolid ? '#F5F5F5' : 'rgba(255,255,255,0.15)',
                    color: isSolid ? '#032D46' : 'white',
                    border: `1px solid ${isSolid ? '#E0E0E0' : 'rgba(255,255,255,0.3)'}`,
                    borderRadius: '8px',
                    padding: '12px 16px',
                    fontSize: '16px',
                    outline: 'none',
